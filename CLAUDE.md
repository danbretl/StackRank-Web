...
- **`lib/`** — DOM-free ES modules extracted from `app.js` and shared by the browser app plus tests (`zip`, `text`, `format`, `movie`, `insights`, `packs`, `share-export`, `share-svg`, `ranking`, `undo`).
