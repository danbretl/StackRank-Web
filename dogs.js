...
const RIGHTS_URL = "data/dogs/image-rights.json?v=23";
const RIGHTS_POLICY_URL = "data/dogs/artwork-license-policy.json?v=1";
const PROFILES_URL = "data/dogs/breed-profiles.json?v=9";
const GENERATED_ARTWORK_URL = "data/dogs/generated-artwork.json?v=16";
