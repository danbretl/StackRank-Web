...
Current artwork progress supersedes the baseline below: `95afac08` includes batch D and cohort E01–E07
for 213 live portraits. Continue from `notes/testing/dogs-portrait-cohort-e.md` and the frozen
