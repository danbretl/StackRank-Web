...
Current artwork progress supersedes the baseline below: `732ebacc` includes batch D and cohort E01–E04
for 145 live portraits. Continue from `notes/testing/dogs-portrait-cohort-e.md` and the frozen
